...
class Assets {
	...
	private static function initialize ():Void {
		...
		if (!initialized) {
			...
			resourceClasses.set ("assets/images/spaceman.png", NME_assets_images_spaceman_png);
			resourceTypes.set ("assets/images/spaceman.png", "image");
			resourceClasses.set ("assets/images/tech_tiles.png", NME_assets_images_tech_tiles_png);
			resourceTypes.set ("assets/images/tech_tiles.png", "image");
			resourceClasses.set ("images/spaceman.png", NME_images_spaceman_png);
			resourceTypes.set ("images/spaceman.png", "image");
			resourceClasses.set ("images/tech_tiles.png", NME_images_tech_tiles_png);
			resourceTypes.set ("images/tech_tiles.png", "image");
