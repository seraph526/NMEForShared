...
class ApplicationMain {
	...
	public static function getAsset (inName:String):Dynamic {
		...
		if (inName=="assets/images/spaceman.png")
			 
            return Assets.getBitmapData ("assets/images/spaceman.png");
         
		
		if (inName=="assets/images/tech_tiles.png")
			 
            return Assets.getBitmapData ("assets/images/tech_tiles.png");
         
		
		if (inName=="images/spaceman.png")
			 
            return Assets.getBitmapData ("images/spaceman.png");
         
		
		if (inName=="images/tech_tiles.png")
			 
            return Assets.getBitmapData ("images/tech_tiles.png");
...
class NME_assets_images_spaceman_png extends nme.display.BitmapData { public function new () { super (0, 0); } }
class NME_assets_images_tech_tiles_png extends nme.display.BitmapData { public function new () { super (0, 0); } }
class NME_images_spaceman_png extends nme.display.BitmapData { public function new () { super (0, 0); } }
class NME_images_tech_tiles_png extends nme.display.BitmapData { public function new () { super (0, 0); } }
