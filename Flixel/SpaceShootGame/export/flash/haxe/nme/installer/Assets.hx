...
class Assets {
	...
	private static function initialize ():Void {
		...
		if (!initialized) {
			...
			resourceClasses.set ("assets/gfx/bullet.png", NME_assets_gfx_bullet_png);
			resourceTypes.set ("assets/gfx/bullet.png", "image");
			resourceClasses.set ("assets/gfx/player.png", NME_assets_gfx_player_png);
			resourceTypes.set ("assets/gfx/player.png", "image");
