...
class ApplicationMain {
	...
	public static function getAsset (inName:String):Dynamic {
		...
		if (inName=="assets/gfx/bullet.png")
			 
            return Assets.getBitmapData ("assets/gfx/bullet.png");
         
		
		if (inName=="assets/gfx/player.png")
			 
            return Assets.getBitmapData ("assets/gfx/player.png");
...
class NME_assets_gfx_bullet_png extends nme.display.BitmapData { public function new () { super (0, 0); } }
class NME_assets_gfx_player_png extends nme.display.BitmapData { public function new () { super (0, 0); } }
